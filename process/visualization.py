...
class VisImage:
    ...
    def save(self, filepath):
        ...
        """
        if filepath.lower().endswith(".png") or filepath.lower().endswith(".png"):
...
def arg_parser():
    ...
    parser.add_argument('--img-dir', type=str, default='/home/whut/PaddleSeg/image_4000/',
                        help='path to image files.')
    parser.add_argument('--label-dir', type=str, default='/home/whut/PaddleSeg/mask_4000/',
